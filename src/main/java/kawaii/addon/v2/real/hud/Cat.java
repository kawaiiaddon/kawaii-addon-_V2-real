...
public class Cat extends HudElement {
    ...
    public void render(HudRenderer renderer) {
        switch (mode.get()) {
            case Cat1 -> TEXTURE = Identifier.fromNamespaceAndPath("kawaii-addon", "hud/cat1.png");
            case Cat2 -> TEXTURE = Identifier.fromNamespaceAndPath("kawaii-addon", "hud/cat2.png");
            case Cat3 -> TEXTURE = Identifier.fromNamespaceAndPath("kawaii-addon", "hud/cat3.png");
            case Cat4 -> TEXTURE = Identifier.fromNamespaceAndPath("kawaii-addon", "hud/cat4.png");
            case Cat5 -> TEXTURE = Identifier.fromNamespaceAndPath("kawaii-addon", "hud/cat5.png");
            case Cat6 -> TEXTURE = Identifier.fromNamespaceAndPath("kawaii-addon", "hud/cat6.png");
            case Cat7 -> TEXTURE = Identifier.fromNamespaceAndPath("kawaii-addon", "hud/cat7.png");
            case Cat8 -> TEXTURE = Identifier.fromNamespaceAndPath("kawaii-addon", "hud/cat8.png");
            case Cat9 -> TEXTURE = Identifier.fromNamespaceAndPath("kawaii-addon", "hud/cat9.png");
            case Cat10 -> TEXTURE = Identifier.fromNamespaceAndPath("kawaii-addon", "hud/cat10.png");
            case Cat11 -> TEXTURE = Identifier.fromNamespaceAndPath("kawaii-addon", "hud/cat11.png");
            case Cat12 -> TEXTURE = Identifier.fromNamespaceAndPath("kawaii-addon", "hud/cat12.png");
