        ...
        if (cosmeticType.get() == CosmeticType.Chinese_Hat && hatEnabled.get()) {
            ...
            if (particles.get()) {
                ...
                while (it.hasNext()) {
                    ...
                    event.renderer.quad(ax1, p.py-size*0.4, az1, ax1, p.py+size*0.4, az1, ax2, p.py+size*0.4, az2, ax2, p.py-size*0.4, az2, pc);
                    event.renderer.quad(bx1, p.py-size*0.4, bz1, bx1, p.py+size*0.4, bz1, bx2, p.py+size*0.4, bz2, bx2, p.py-size*0.4, bz2, pc);
                    event.renderer.quad(p.px-size*0.4, p.py-size*0.4, p.pz, p.px+size*0.4, p.py-size*0.4, p.pz, p.px+size*0.4, p.py+size*0.4, p.pz, p.px-size*0.4, p.py+size*0.4, p.pz, pc);
                }
            }
